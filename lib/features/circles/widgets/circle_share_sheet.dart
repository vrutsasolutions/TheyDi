...
class _CircleShareSheetState extends State<CircleShareSheet> {
  ...
  Future<void> _shareExternal(String url, String platformName) async {
    if (platformName == 'Instagram') {
      final text = CircleShareService.buildShareText(widget.circle);
...
// ─────────────────────────────────────────────────────────────────────────────
// In-App Share Sheet — sends circle_invite message to selected friends
// ─────────────────────────────────────────────────────────────────────────────
class _InAppFriendCircleShareSheet extends StatefulWidget {
  final CircleModel circle;
  const _InAppFriendCircleShareSheet({required this.circle});

  @override
  State<_InAppFriendCircleShareSheet> createState() =>
